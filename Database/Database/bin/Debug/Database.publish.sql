...
GO
PRINT N'正在建立 資料表 [dbo].[Base_User]...';
...
CREATE TABLE [dbo].[Base_User] (
    ...
    CONSTRAINT [PK_Base_User] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
PRINT N'正在建立 索引 [dbo].[Base_User].[Cix_Base_User]...';


GO
CREATE NONCLUSTERED INDEX [Cix_Base_User]
    ON [dbo].[Base_User]([Cix] ASC);


GO
PRINT N'正在建立 預設條件約束 [dbo].[Base_User] 上的未命名條件約束...';
